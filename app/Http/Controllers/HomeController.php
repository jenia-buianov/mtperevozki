        ...
        $data = [
            ...
            'statistics'=>[
                'cargo'=>[
                    ...
                    'sea'=>[url('images/statistics/sea.jpg'),RemoteAutoCargo::where('type',15)->where('hidden',0)->count()],
                    'rails'=>[url('images/statistics/train.jpg'),RemoteAutoCargo::where('type',44)->where('hidden',0)->count()],
                ...
                'transport'=>[
                    ...
                    'sea'=>[url('images/statistics/sea.jpg'),RemoteAutoTransport::where('type',15)->where('hidden',0)->count()],
                    'rails'=>[url('images/statistics/train.jpg'),RemoteAutoTransport::where('type',44)->where('hidden',0)->count()],
