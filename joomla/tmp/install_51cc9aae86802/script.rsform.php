...
.big-warning b {
	...
	<div id="installer-right">
		...
		<ul class="version-history">
			<li><span class="version-upgraded">Upg</span> Joomla! 3.0 compatibility</li>
			<li><span class="version-upgraded">Upg</span> Ability to set/unset required fields without editing the field properties</li>
			<li><span class="version-new">New</span> Export to OpenDocument Spreadsheet</li>
			<li><span class="version-new">New</span> New triggers that allow for ReCAPTCHA to be validated through AJAX</li>
			<li><span class="version-new">New</span> New placeholders for Submissions View: {details_link} and {detailspdf_link}</li>
			<li><span class="version-new">New</span> New Payment Plugin that allows for multiple payment options on the same form</li>
			<li><span class="version-new">New</span> Payment Plugin now supports a "donation" field</li>
			<li><span class="version-new">New</span> Offline Payment Plugin</li>
			<li><span class="version-fixed">Fix</span> Captcha now shows the required marker</li>
		</ul>
