...
<?php if($mosConfig_lang == 'russian') { echo "Наименование груза"; }
...
<?php if($mosConfig_lang == 'russian') { echo "Страна погрузки"; }
...
<td align="left" style="padding-bottom:8px;">
<?php
    if($mosConfig_lang == 'russian') { echo'Город разгрузки';}
...
<input type="submit" name="submit" value="<?php if($mosConfig_lang == 'russian') { echo "Предложить"; }
								elseif ($mosConfig_lang == 'romanian') { echo "Ofera"; }
								elseif ($mosConfig_lang == 'english') { echo "Suggest"; }
								?>" id="submit" />
</td>
</tr>
