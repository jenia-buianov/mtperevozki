...
if ($_POST) {
	...
	if (is_valid_data($_POST['import_country']) and is_valid_data($_POST['export_country']) and is_valid_data($_POST['date_export']) and is_valid_data($_POST['type_transport']) and is_valid_data($_POST['company']) and is_valid_data($_POST['cargo_size']) and is_valid_data($_POST['fio']) and isValidEmail($_POST['email'], false) and is_valid_telefone($_POST['telefon_country_code'], $_POST['telefon_city_code'], $_POST['telefon'])) {
...
<table class="bold" border="0" width="500">
...
<td align="left" style="padding-bottom:8px;">
<select type="select" name="import_city" size="1" id="import_city"  style="width: 175px" onchange="updateSelect('ignore', this.value, 'import_city');" style="width: 175px">
...
<td align="left" style="padding-bottom:8px;">
<select type="select" name="export_city" size="1" id="export_city" style="width: 175px" onchange="updateSelect('ignore', this.value, 'export_city');" style="width: 175px" >
<option value="0"><?php if($mosConfig_lang == 'russian') {
	echo '---не имеет значения---';}
    elseif($mosConfig_lang == 'romanian') { echo'---oricare---';}
    elseif($mosConfig_lang == 'english') { echo'---all cities---';}
...
<?php if($mosConfig_lang == 'russian') {
	echo 'Свободен с';}
    elseif($mosConfig_lang == 'romanian') { echo'Liber din';}
    elseif($mosConfig_lang == 'english') { echo'Free from';}
?> <span style="color: red">*</span>
</td>
<td style="padding-bottom:8px;">
