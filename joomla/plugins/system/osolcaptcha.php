...
<p style="margin-top: 6px;">
			<?php //echo JText::_('ENTER CAPTCHA VALUE') ?>
			<label style="margin-top: 0px;"><img id="captchaCode<?php echo $GLOBALS['totalCaptchas'] ?>" src="<?php echo JURI::base()."index.php?showCaptcha=True&amp;instanceNo=".$GLOBALS['totalCaptchas'] ?>" alt="Captcha" /></label>
			<input type="text" class="inputbox" name="osolCatchaTxt" id="osolCatchaTxt<?php echo $GLOBALS['totalCaptchas'] ?>" /><br />
			<label><?php echo JText::_('MTP_CAPTCHA') ?> *</label>
			<a style="margin: 5px 0 0 219px;clear:both;float: left;" href="#" onclick="reloadCapthcha<?php echo $GLOBALS['totalCaptchas'] ?>(<?php echo $GLOBALS['totalCaptchas'] ?>);return false;"><?php echo JText::_('MTP_CAPTCHA_OTHER') ?></a>
			<input type="hidden" name="osolCatchaTxtInst" id="osolCatchaTxtInst"  value="<?php echo $GLOBALS['totalCaptchas'] ?>" />
				<script language="javascript" type="text/javascript">
					//<![CDATA[
					function reloadCapthcha<?php echo $GLOBALS['totalCaptchas'] ?>(instanceNo){
						var captchaSrc = '<?php echo JURI::base() ?>index.php?showCaptcha=True&instanceNo='+instanceNo+'&time='+ new Date().getTime();
