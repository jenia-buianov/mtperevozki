...
<div id="installer">
<p><?php echo JText::_('LOADSQLFILE') ?></p>
</div>
			<?php echo $pct_bar; ?>
<p><?php echo $kbytes_done ?> / <?php echo $kbytes_tota ?> kB (<?php echo $queries?>
queries)</p>

<form action="index.php" method="post" name="migrateForm"
	id="migrateForm" class="form-validate" target="restorationtarget"><input
	type="hidden" name="task" value="dumpLoad" /> <input type="hidden"
	name="fn" value="<?php echo $_REQUEST["fn_original"]; ?>" /> <input
	type="hidden" name="resdbtype" value="<?php echo $DBtype ?>" /> <input
	type="hidden" name="resdbhost" value="<?php echo $DBhostname ?>" /> <input
	type="hidden" name="resdbuser" value="<?php echo $DBuserName ?>" /> <input
	type="hidden" name="resdbpass" value="<?php echo $DBpassword ?>" /> <input
	type="hidden" name="resdbname" value="<?php echo $DBname ?>" /> <input
	type="hidden" name="resprefix" value="<?php echo $DBPrefix ?>" /> <input
	type="hidden" name="start" value="<?php echo $linenumber ?>" /> <input
	type="hidden" name="foffset" value="<?php echo $foffset ?>" /> <input
	type="hidden" name="totalqueries" value="<?php echo $totalqueries ?>" />
