...
return $n;
 ...
 <div class="form-group">
    ...
    <select class="form-control" style="padding: 0px;    width: 150px" id="country_from" name="country_from"><option value=""><?php if (LANG=='ru') echo'Выберите страну погрузки</option><option value="">Все страны';?><?php if (LANG=='ro') echo'Selectați țara</option><option value="">Toate țările';?><?php if (LANG=='en') echo'Select loading country</option><option value="">All countries';?></option><?php echo $countries; ?></select>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="country_to" style="padding: 0px;    width: 150px"  name="country_to"><option value=""><?php if (LANG=='ru') echo'Выберите страну разгрузки</option><option value="">Все страны';?><?php if (LANG=='ro') echo'Selectați țara</option><option value="">Toate țările';?><?php if (LANG=='en') echo'Select unloading country</option><option value="">All countries';?></option><?php echo $countries2; ?></select>
  ...
  <div class="form-group">
    ...
    <select class="form-control" style="padding: 0px;    width: 150px"  id="transport_type" name="transport_type"><option value=""><?php if (LANG=='ru') echo'Выберите тип транспорта</option><option value="">Все виды автоперевозок';?><?php if (LANG=='ro') echo'Selectați tipul transportului</option><option value="">Toate tipurlile auto transrotărillor';?><?php if (LANG=='en') echo'Select transport type</option><option value="">All typies of auto transportations';?></option><?php echo $transport_types; ?></select>
