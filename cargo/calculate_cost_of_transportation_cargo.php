...
?>
 <span style="color: red">*</span></label></td>
<td style="padding-bottom:8px;"><span id="fio_span"><input type="text" name="fio" size="25" id="fio"  class="form-control" value="<?php echo $_POST['fio'] ?>"  style="width:100%;padding: 3px 5px;font-size: 1em; height:auto"/></span></td>
</tr>
<tr>
...
<td style="padding-bottom:8px;"><span id="email_span"><input type="text" name="email" size="25" id="email"  class="form-control" value="<?php echo $_POST['email'] ?>" style="padding: 3px 5px;font-size: 1em;height:auto" /></span></td>
</tr>
